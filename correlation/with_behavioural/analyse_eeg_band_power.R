...
outcome_variable <- "theta"

# Read the data from the CSV file
data <- read.csv(paste("processed_data/event7to9/42-event7to9.csv", sep=""), sep=",")

data[[outcome_variable]] <- as.numeric(data[[outcome_variable]])

output_file <- paste("processed_data/event7to9/42-", outcome_variable, "-output.csv", sep="")
