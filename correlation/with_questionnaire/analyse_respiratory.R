...
data <- read.csv(paste("processed_data/respiratory/42-", outcome_variable, ".csv", sep=""), sep=",")

output_file <- paste("processed_data/respiratory/42-", outcome_variable, "-output.csv", sep="")
