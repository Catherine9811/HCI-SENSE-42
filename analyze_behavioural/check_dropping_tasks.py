...
y_values = []
for entry in task:
    last_mouse_pos = np.array([entry["last_clicked_offset"][0] + entry["file_dragging.stimuli_dragging_mouse.x"][-1],
    ...
    y_values.append(np.linalg.norm(last_mouse_pos - target_mouse_pos))
