...
raw = mne.io.read_raw_eeglab(r"../data/EEG/P001_RM_PowerLine_ICA.set", preload=True)
...
first_segment.plot_psd(ax=ax[0], fmax=50, average=True, show=False)
ax[0].set_title('PSD of First 30 Minutes')
ax[0].set_xlabel('Frequency (Hz)')
ax[0].set_ylabel('Power Spectral Density (dB)')
ax[0].set_ylim(-10, 15)
# Plot PSD for the last 30 minutes
last_segment.plot_psd(ax=ax[1], fmax=50, average=True, show=False)
