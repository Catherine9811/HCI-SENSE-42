...
uses LightGBM (LGBMClassifier) instead of RandomForestClassifier.
...
PR_CURVE_WITHIN_PATH = (
    BASE_DIR / "processed_data" / "sleepiness_gb_binary_participant_iqr_scaled_pr_curve_within.png"
)
PR_CURVE_CROSS_PATH = (
    BASE_DIR / "processed_data" / "sleepiness_gb_binary_participant_iqr_scaled_pr_curve_cross.png"
)
