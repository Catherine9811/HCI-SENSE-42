...
"""
Binary alertness prediction script using LightGBM.
...
PR_CURVE_WITHIN_PATH = (
    BASE_DIR / "processed_data" / "alertness_lgbm_binary_participant_iqr_scaled_pr_curve_within.png"
)
PR_CURVE_CROSS_PATH = (
    BASE_DIR / "processed_data" / "alertness_lgbm_binary_participant_iqr_scaled_pr_curve_cross.png"
)
...
def main() -> None:
    ...
    run_binary_lgbm_experiments(lower_percentile=0.49, upper_percentile=0.51)
