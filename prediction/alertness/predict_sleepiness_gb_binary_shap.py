...
"""
SHAP-based feature importance analysis for sleepiness binary prediction using Gradient Boosting.

This script uses SHAP (SHapley Additive exPlanations) to identify and rank
the most important features contributing to sleepiness binary classification predictions
...
def analyze_feature_importance_shap(
    ...
    """
    Analyze feature importance using SHAP for sleepiness binary classification.
    """
    ...
    # Save results to CSV
    output_path = BASE_DIR / "processed_data" / "sleepiness_gb_binary_shap_importance.csv"
    ...
    group_output_path = (
        BASE_DIR / "processed_data" / "sleepiness_gb_binary_shap_group_contribution.csv"
    )
